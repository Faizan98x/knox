...
import { HybridThreePhaseData } from "../../../Data/SliderData";

import * as BsIcons from "react-icons/bs";
import * as FaIcons from "react-icons/fa";
import { motion } from "framer-motion";

function HybridThreePhase() {
  return (
    <>
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        <div className="product1">
          <div className="product1-left-side">
            <ImageSlider Sliderdata={HybridThreePhaseData} slides={HybridThreePhaseData} />
          </div>
          <div className="product1-right-side">
            <h6>Hybrid Three Phase Inverter</h6>
            <p>ASW 8-12 kW H-T1 Series</p>
            <p>ASW 08 kW H-T1 / ASW 10 kW H-T1 / ASW 12 kW H-T1</p>
            <ul>
              <h6>Benefits</h6>
              <li>
...
export default HybridThreePhase;
