      ...
      >
        <div className="product1">
          <div className="product1-left-side">
            <ImageSlider Sliderdata={HybridSinglePhaseData} slides={HybridSinglePhaseData} />
          </div>
          <div className="product1-right-side">
            <h6>Hybrid Single Phase Inverter</h6>
            <p>ASW 3-6 kW H-S2 Series</p>
            <p>ASW 3000 H-S2 / 3680 H-S2 / 4000 H-S2 / 5000 H-S2 / 6000 H-S2</p>
            <ul>
              <h6>Benefits</h6>
              <li>
...
export default HybridSinglePhase