...
import { SSeries6to10kWData } from "../../../Data/SliderData";

import * as BsIcons from "react-icons/bs";
import * as FaIcons from "react-icons/fa";
import { motion } from "framer-motion";

function SSeries6to10kW() {
  return (
    <>
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        <div className="product1">
          <div className="product1-left-side">
            <ImageSlider Sliderdata={SSeries6to10kWData} slides={SSeries6to10kWData} />
          </div>
          <div className="product1-right-side">
            <h6>Single Phase Inverter</h6>
            <p>ASW 6-10 kW S Series</p>
            <ul>
              <h6>Benefits</h6>
              <li>
