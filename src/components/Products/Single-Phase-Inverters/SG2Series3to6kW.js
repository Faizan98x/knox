...
import { SG2Series3to6kWData } from "../../../Data/SliderData";

import * as BsIcons from "react-icons/bs";
import * as FaIcons from "react-icons/fa";
import { motion } from "framer-motion";

function SG2Series3to6kW() {
  return (
    <>
    <motion.div
      initial={{ opacity: 0 }}
    ...
    >
      <div className="product1">
        <div className="product1-left-side">
          <ImageSlider Sliderdata={SG2Series3to6kWData} slides={SG2Series3to6kWData} />
        </div>
        <div className="product1-right-side">
          <h6>Single Phase Inverter</h6>
          <p>ASW 3-6 kW S G2 Series</p>
          <ul>
            <h6>Benefits</h6>
            <li>
...
export default SG2Series3to6kW