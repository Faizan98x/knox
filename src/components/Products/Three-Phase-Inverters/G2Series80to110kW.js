...
import { G2Series80to110kWData } from "../../../Data/SliderData";

import * as BsIcons from "react-icons/bs";
import * as FaIcons from "react-icons/fa";
import { motion } from "framer-motion";

function G2Series80to110kW() {
  return (
    <>
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        <div className="product1">
          <div className="product1-left-side">
            <ImageSlider Sliderdata={G2Series80to110kWData} slides={G2Series80to110kWData} />
          </div>
          <div className="product1-right-side">
            <h6>Three Phase Inverter</h6>
            <p>ASW 80-110 kW G2 Series</p>
            <ul>
              <h6>Benefits</h6>
              <li>
...
export default G2Series80to110kW;
