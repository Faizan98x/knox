...
import { G3Series10to40kWData } from "../../../Data/SliderData";

import * as BsIcons from "react-icons/bs";
import * as FaIcons from "react-icons/fa";
import { motion } from "framer-motion";

function G3Series10to40kW() {
  return (
    <>
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        <div className="product1">
          <div className="product1-left-side">
            <ImageSlider Sliderdata={G3Series10to40kWData} slides={G3Series10to40kWData} />
          </div>
          <div className="product1-right-side">
            <h6>Three Phase Inverter</h6>
            <p>ASW 10-40 kW G3 Series</p>
            <ul>
              <h6>Benefits</h6>
              <li>
...
export default G3Series10to40kW