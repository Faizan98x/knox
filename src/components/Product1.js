    ...
    <>
        ...
        <div className="product1-right-side">
          ...
          <ul>
            ...
            <li>
              ...
              <span>150% oversizing of PV array with integrated DC switch</span>
            </li>
            <li>
      ...
      <div className="product1-details">
        ...
        <p>
          ...
          applicable The ASW S series single phase inverter combines all aspects
          of our believes into a compact, award winning, IP66 rated design. With
          its discreet design and silent operation, the ASW S inverter blends
          seamlessly into the comforts of your family surroundings. ​
          <br />
        ...
        <p>
          ...
          operation with a strong focus on safety for installers and end-users.
        </p>
        <h6>Powerful</h6> <br />
        <p>
        ...
        <p>
          ...
          <br /> Plug and play Wi-Fi and 4G sticks which allows easy monitoring
          of up to five inverters.​ <br /> Quick setup and easy commissioning
          with Aiswei Apps.
        </p>
      </div>
